...
# This is a pickle object.
MODEL_LT_GBM_APR = Path.joinpath(MODELS_DIR, 'lightGBM_APR_2021')    
MODEL_LT_GBM_MAY = Path.joinpath(MODELS_DIR, 'lightGBM_MAY_2021')
...
FORECAST_WEATHER_CSV = Path.joinpath(PROCESSED_DATA_DIR, 'forecastedWeatherInfoFull_2.csv')  
...
PROCESSED_TRAIN_DATA_1 = Path.joinpath(PROCESSED_DATA_DIR, 'cleaned_RF_corrected_MA_Last_LN_added.csv')
